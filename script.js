function classificarHeroi() {
    ...
    if (vitoria) {
        // @ts-ignore
        heroMainImage.src = `src/hero-image/nalva-vitoria.png`;
        // @ts-ignore
        resultadoImagem.innerHTML = `<img src="src/hero-image/nalva-vitoria${fase}.png alt="Nalva ${nome}">`;
    } else if (xp >= 5201 && xp <= 7300){
        // @ts-ignore
        heroMainImage.src = `src/hero-image/Frank-vilao.png`;
        // @ts-ignore
        resultadoImagem.innerHTML = `<img src="src/hero-image/Frank-vilao${fase}.png" alt="Vilão ${nome}">`;
    } else if (xp < 100) {
        // @ts-ignore
