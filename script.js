function classificarHeroi() {
    ...
    if (vitoria) {
        // @ts-ignore
        heroMainImage.src = `src/hero-image/nalva-hero.png`;
        // @ts-ignore
        resultadoImagem.innerHTML = `<img src="src/hero-image/nalva-vitoria${fase}.png" alt="Herói(a) venceu na fase ${fase}">`;
    } else {
        // @ts-ignore
        heroMainImage.src = `src/hero-image/Frank-vilao.png`;
        // @ts-ignore
        resultadoImagem.innerHTML = `<img src="src/hero-image/Frank-vilao${fase}.png" alt="Vilão na fase ${fase}">`;
    }

    if (xp < 100) {
        // @ts-ignore
        heroMainImage.src = `src/hero-image/derrota.png`;
        // @ts-ignore
        resultadoImagem.innerHTML = `<img src="src/hero-image/derrota.png" alt="Derrota">`;
    }
}
